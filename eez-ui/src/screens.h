...
enum ScreensEnum {
    _SCREEN_ID_FIRST = 1,
    SCREEN_ID_NEW_PROFILE_SCREEN = 1,
    SCREEN_ID_STANDBY_SCREEN = 2,
    SCREEN_ID_MENU_SCREEN = 3,
    SCREEN_ID_BREW_SCREEN = 4,
    SCREEN_ID_PROFILE_SCREEN = 5,
...
typedef struct _objects_t {
    ...
    lv_obj_t *down_duration_button_1;
    lv_obj_t *brew_target_weight_container;
    lv_obj_t *target_weight_1;
    lv_obj_t *obj49;
    lv_obj_t *up_weight_button_1;
    lv_obj_t *down_duration_button_2;
    lv_obj_t *down_duration_button_3;
    ...
    lv_obj_t *down_duration_button1_1;
    lv_obj_t *up_duration_button1_1;
