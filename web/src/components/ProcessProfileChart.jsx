 ...
 */
export function ProcessProfileChart({ data, processInfo = null, className = 'max-h-36 w-full', style }) {
  ...
  return (
    <ExtendedProfileChart data={data} className={className} style={style} selectedPhase={activePhaseIndex} showPhaseLabels={false} />
  );
}
