...
export const getStickyBottom = () => {
  if (typeof globalThis.window === 'undefined' || !globalThis.window.localStorage) return true;
  try {
...
export const getStickyTop = () => {
  if (typeof globalThis.window === 'undefined' || !globalThis.window.localStorage) return false;
  try {
...
export const getMetricsColumns = () => {
  if (typeof globalThis.window === 'undefined' || !globalThis.window.localStorage) return 2;
  try {
...
export const getProfileChartHeight = () => {
  if (typeof globalThis.window === 'undefined' || !globalThis.window.localStorage) return 128;
  try {
...
export const getRecentShotCount = () => {
  if (typeof globalThis.window === 'undefined' || !globalThis.window.localStorage) return 4;
  try {
