...
export function LibraryPanel({
  ...
  const canRetryPrimaryProfileSearch =
  ...
  const canRetryCompareProfileSearch =
  ...
  const selectionPromotionsEnabled = !collapsed;
            ...
            <div>
              ...
              <StatusBar
                ...
                onShowStats={() =>
                  onShowStats?.({
                    shotSource:
                      secondaryDisplayShot?.source || primaryDisplayShot?.source || 'both',
