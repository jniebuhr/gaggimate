...
import { ProfileListSkeleton } from '../../components/skeletons/ProfileListSkeleton.jsx';
...
function ProfileCard({
  ...
  return (
    <Card role='listitem' className='profile-card-container col-span-12 [&>.card-body]:p-0 [&>.card-body]:gap-0 overflow-hidden'>
      ...
      >
        {/* Checkbox — no-toggle class prevents accordion toggle */}
        <div className='flex items-center shrink-0 no-toggle'>
        ...
        {/* Actions — no-toggle class prevents accordion toggle */}
        <div
          className='flex items-center gap-2 shrink-0 no-toggle'
          role='group'
