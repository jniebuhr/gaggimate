...
export function StatisticsSearchHelp() {
  return (
    <details className='dropdown dropdown-end'>
      <summary
        className='flex h-9 min-h-0 w-9 list-none items-center justify-center rounded-lg border border-base-content/10 bg-base-100/45 px-0 text-base-content/60 shadow-sm transition-colors hover:bg-base-200/60 hover:text-base-content [&::-webkit-details-marker]:hidden'
        ...
        <div className='space-y-2 text-xs leading-relaxed'>
          ...
          <div className='rounded-lg bg-base-200/60 p-2'>
            ...
            <p className='opacity-70'>
              Date basis (<code>Shot / Auto / Upload</code>) appears only when missing shot timestamps are detected.
            </p>
          </div>
          <div className='rounded-lg bg-base-200/60 p-2'>
            <p className='font-semibold'>Raw / Calc</p>
            <p className='opacity-80'>
              Raw builds statistics directly from the values stored in the shot file and only reuses the analyzer&apos;s detected stop reasons.
            </p>
            <p className='opacity-80'>
              Calc builds statistics from the analyzer&apos;s calculated values so the results align with analyzer-based stop detection.
            </p>
