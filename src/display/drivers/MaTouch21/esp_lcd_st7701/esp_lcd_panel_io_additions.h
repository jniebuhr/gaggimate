...
typedef struct {
    ...
    union {
        ...
        int cs_expander_pin;  /*!< IO expander pin used for CS line */
    };
    panel_io_type_t scl_io_type;                    /*!< IO type of SCL line */
    union {
        int scl_gpio_num;                           /*!< GPIO used for SCL line */
        int scl_expander_pin; /*!< IO expander pin used for SCL line */
    };
    panel_io_type_t sda_io_type;                    /*!< IO type of SDA line */
    union {
        int sda_gpio_num;                           /*!< GPIO used for SDA line */
        int sda_expander_pin; /*!< IO expander pin used for SDA line */
    };
    int io_expander;           /*!< IO expander handle, set to NULL if not used */
} spi_line_config_t;
