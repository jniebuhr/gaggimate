...
DRAM_ATTR static const lcd_init_cmd_t st7701_2_8_inches[] = {
    ...
    {0xC0, {0x3B, 0X00}, 0x02},
    {0xC1, {0x10, 0x0C}, 0x02},
    // INVSET first byte 0x31 (was 0x07): the vendored value drove the glass in
    ...
    {0xFF, {0x77, 0x01, 0x00, 0x00, 0x11}, 0x05},
    {0xb0, {0x5d}, 0x01},
    // VCOMS 0x48 = 1.0 V (vendored table shipped 0x2D = 0.66 V). Raising VCOM
    // toward the values other ST7701S configs use measurably reduced inversion
    // flicker on gradients (VCOM = 0.1 + n*0.0125 V).
    {0xb1, {0x48}, 0x01},
    {0xb2, {0x81}, 0x01},
    {0xb3, {0x80}, 0x01},
    {0xb5, {0x4E}, 0x01},
    {0xb7, {0x8C}, 0x01}, // source-amp bias at IC default (vendored table shipped reduced 0x85)
    {0xb8, {0x20}, 0x01},
    {0xc1, {0x78}, 0x01},
    {0xc2, {0x78}, 0x01},
    {0xd0, {0x88}, 0x01},
