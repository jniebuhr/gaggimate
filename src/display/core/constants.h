...
constexpr int HOT_WATER_SAFETY_DURATION_MS = 120000;
constexpr int HOT_WATER_MIN_DURATION_MS = 0;
constexpr int HOT_WATER_MAX_DURATION_MS = HOT_WATER_SAFETY_DURATION_MS;
constexpr double HOT_WATER_MIN_VOLUMETRIC = 5.0;
constexpr double HOT_WATER_MAX_VOLUMETRIC = 1000.0;
