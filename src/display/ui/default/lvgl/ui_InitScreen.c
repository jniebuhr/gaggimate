...
void ui_InitScreen_screen_init(void)
{
    ...
    ui_InitScreen_Image2 = lv_image_create(ui_InitScreen);
    lv_image_set_src(ui_InitScreen_Image2, &ui_img_logo_png);
    ...
    lv_obj_remove_flag(ui_InitScreen_Image2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_scale(ui_InitScreen_Image2, 210);
    ui_object_set_themeable_style_property(ui_InitScreen_Image2, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMAGE_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_InitScreen_Image2, LV_PART_MAIN | LV_STATE_DEFAULT,
