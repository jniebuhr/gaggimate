...
lv_obj_t * ui_StandbyScreen_Image1 = NULL;
...
void ui_StandbyScreen_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_StandbyScreen, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_StandbyScreen_Image1 = lv_image_create(ui_StandbyScreen);
    lv_image_set_src(ui_StandbyScreen_Image1, &ui_img_logo_png);
    ...
    lv_obj_remove_flag(ui_StandbyScreen_Image1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_scale(ui_StandbyScreen_Image1, 210);
    ui_object_set_themeable_style_property(ui_StandbyScreen_Image1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMAGE_RECOLOR,
    ...
    lv_obj_remove_flag(ui_StandbyScreen_Container1, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags

    ui_StandbyScreen_wifiIcon = lv_image_create(ui_StandbyScreen_Container1);
    lv_image_set_src(ui_StandbyScreen_wifiIcon, &ui_img_364513079);
    ...
    lv_obj_remove_flag(ui_StandbyScreen_wifiIcon, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_StandbyScreen_bluetoothIcon = lv_image_create(ui_StandbyScreen_Container1);
    lv_image_set_src(ui_StandbyScreen_bluetoothIcon, &ui_img_1091371356);
    ...
    lv_obj_remove_flag(ui_StandbyScreen_bluetoothIcon, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_StandbyScreen_updateIcon = lv_image_create(ui_StandbyScreen_Container1);
    lv_image_set_src(ui_StandbyScreen_updateIcon, &ui_img_1765671371);
    ...
    lv_obj_remove_flag(ui_StandbyScreen_updateIcon, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_StandbyScreen_Image3 = lv_image_create(ui_StandbyScreen);
    lv_image_set_src(ui_StandbyScreen_Image3, &ui_img_1732953241);
    ...
    lv_obj_remove_flag(ui_StandbyScreen_Image3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_scale(ui_StandbyScreen_Image3, 210);
    ui_object_set_themeable_style_property(ui_StandbyScreen_Image3, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMAGE_RECOLOR,
                                           _ui_theme_color_NiceWhite);
