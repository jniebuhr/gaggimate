...
LV_IMG_DECLARE( ui_img_pattern_art_deco_fixed_png);   // assets/PATTERN ART DECO_fixed.png
...
LV_IMG_DECLARE( ui_img_coffee_sleep_60x60_png);   // assets/coffee_sleep_60x60.png
...
LV_IMG_DECLARE( ui_img_coffee_sleep_150x150_png);   // assets/coffee_sleep_150x150.png
...
LV_IMG_DECLARE( ui_img_226045815);   // assets/gaggia-minor.png
