...
void ui_StandbyScreen_screen_init(void) {
    ...
    ui_object_set_themeable_style_property(ui_StandbyScreen_Image1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR_OPA,
    ...
    ui_StandbyScreen_halloweenSpider = lv_img_create(ui_StandbyScreen);
    lv_img_set_src(ui_StandbyScreen_halloweenSpider, &ui_img_spider2_png);
    lv_obj_set_width(ui_StandbyScreen_halloweenSpider, LV_SIZE_CONTENT);  /// 16
    lv_obj_set_height(ui_StandbyScreen_halloweenSpider, LV_SIZE_CONTENT); /// 16
    lv_obj_set_x(ui_StandbyScreen_halloweenSpider, -76);
    lv_obj_set_y(ui_StandbyScreen_halloweenSpider, 53);
    lv_obj_set_align(ui_StandbyScreen_halloweenSpider, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_StandbyScreen_halloweenSpider, LV_OBJ_FLAG_ADV_HITTEST);  /// Flags
    lv_obj_clear_flag(ui_StandbyScreen_halloweenSpider, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenSpider, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenSpider, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);

    ui_StandbyScreen_halloweenBats = lv_img_create(ui_StandbyScreen);
    lv_img_set_src(ui_StandbyScreen_halloweenBats, &ui_img_bats_png);
    lv_obj_set_width(ui_StandbyScreen_halloweenBats, LV_SIZE_CONTENT);  /// 48
    lv_obj_set_height(ui_StandbyScreen_halloweenBats, LV_SIZE_CONTENT); /// 48
    lv_obj_set_x(ui_StandbyScreen_halloweenBats, 190);
    lv_obj_set_y(ui_StandbyScreen_halloweenBats, -59);
    lv_obj_set_align(ui_StandbyScreen_halloweenBats, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_StandbyScreen_halloweenBats, LV_OBJ_FLAG_ADV_HITTEST);  /// Flags
    lv_obj_clear_flag(ui_StandbyScreen_halloweenBats, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenBats, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMG_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenBats, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);

    ui_StandbyScreen_halloweenPumpkin = lv_img_create(ui_StandbyScreen);
    lv_img_set_src(ui_StandbyScreen_halloweenPumpkin, &ui_img_pumpkin_png);
    lv_obj_set_width(ui_StandbyScreen_halloweenPumpkin, LV_SIZE_CONTENT);  /// 60
    lv_obj_set_height(ui_StandbyScreen_halloweenPumpkin, LV_SIZE_CONTENT); /// 60
    lv_obj_set_x(ui_StandbyScreen_halloweenPumpkin, -177);
    lv_obj_set_y(ui_StandbyScreen_halloweenPumpkin, -5);
    lv_obj_set_align(ui_StandbyScreen_halloweenPumpkin, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_StandbyScreen_halloweenPumpkin, LV_OBJ_FLAG_ADV_HITTEST);  /// Flags
    lv_obj_clear_flag(ui_StandbyScreen_halloweenPumpkin, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenPumpkin, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_Dark);
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenPumpkin, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_Dark);
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenPumpkin, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR, _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StandbyScreen_halloweenPumpkin, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMG_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);
