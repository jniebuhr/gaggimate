...
lv_obj_t *ui_BrewScreen_currentDuration = NULL;
...
lv_obj_t *uic_BrewScreen_currentDuration;
...
void ui_BrewScreen_screen_init(void) {
    ...
    ui_BrewScreen_currentDuration = lv_label_create(ui_BrewScreen_modeSwitch);
    lv_obj_set_width(ui_BrewScreen_currentDuration, 150);
    lv_obj_set_height(ui_BrewScreen_currentDuration, 50);
    lv_label_set_text(ui_BrewScreen_currentDuration, "00:00");
    ui_object_set_themeable_style_property(ui_BrewScreen_currentDuration, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_BrewScreen_currentDuration, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,
                                           _ui_theme_alpha_NiceWhite);
    lv_obj_set_style_text_align(ui_BrewScreen_currentDuration, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_BrewScreen_currentDuration, &lv_font_montserrat_34, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_align(ui_BrewScreen_currentDuration, LV_ALIGN_CENTER, -150, 70);

    ui_BrewScreen_weightLabel = lv_label_create(ui_BrewScreen_modeSwitch);
    lv_obj_set_width(ui_BrewScreen_weightLabel, 120);
    lv_obj_set_height(ui_BrewScreen_weightLabel, 30);
    ...
    uic_BrewScreen_currentDuration = ui_BrewScreen_currentDuration;
...
void ui_BrewScreen_screen_destroy(void) {
    ...
    ui_BrewScreen_currentDuration = NULL;
