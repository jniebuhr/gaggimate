...
lv_obj_t * uic_GrindScreen_dials_weightText;
...
lv_obj_t * ui_GrindScreen_timedButton = NULL;
...
void ui_GrindScreen_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_GrindScreen, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_GrindScreen_ImgButton2 = lv_imagebutton_create(ui_GrindScreen);
    lv_imagebutton_set_src(ui_GrindScreen_ImgButton2, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_295763949, NULL);
    ...
    lv_obj_set_style_image_recolor(ui_GrindScreen_ImgButton2, lv_color_hex(0xFAFAFA), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_image_recolor_opa(ui_GrindScreen_ImgButton2, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_remove_flag(ui_GrindScreen_contentPanel7, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_GrindScreen_startButton = lv_imagebutton_create(ui_GrindScreen_contentPanel7);
    lv_imagebutton_set_src(ui_GrindScreen_startButton, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_445946954, NULL);
    ...
    ui_object_set_themeable_style_property(ui_GrindScreen_startButton, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_OUTLINE_OPA, _ui_theme_alpha_Dark);
    ...
    lv_obj_remove_flag(ui_GrindScreen_targetContainer, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_GrindScreen_upDurationButton = lv_imagebutton_create(ui_GrindScreen_targetContainer);
    lv_imagebutton_set_src(ui_GrindScreen_upDurationButton, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_390988422, NULL);
    ...
    lv_obj_set_style_outline_color(ui_GrindScreen_upDurationButton, lv_color_hex(0x000000),
    ...
    ui_GrindScreen_downDurationButton = lv_imagebutton_create(ui_GrindScreen_targetContainer);
    lv_imagebutton_set_src(ui_GrindScreen_downDurationButton, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_834125362, NULL);
    ...
    lv_obj_set_style_outline_color(ui_GrindScreen_downDurationButton, lv_color_hex(0xFAFAFA),
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_GrindScreen_targetSymbol = lv_image_create(ui_GrindScreen_targetContainer);
    lv_image_set_src(ui_GrindScreen_targetSymbol, &ui_img_360122106);
    ...
    lv_obj_remove_flag(ui_GrindScreen_targetSymbol, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_inner_align(ui_GrindScreen_targetSymbol, LV_IMAGE_ALIGN_TILE);
    ...
    lv_obj_remove_flag(ui_GrindScreen_modeSwitch, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_GrindScreen_timedButton = lv_button_create(ui_GrindScreen_modeSwitch);
    ...
    lv_obj_remove_flag(ui_GrindScreen_timedButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_image_src(ui_GrindScreen_timedButton, &ui_img_360122106, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_GrindScreen_volumetricButton = lv_button_create(ui_GrindScreen_modeSwitch);
    ...
    lv_obj_remove_flag(ui_GrindScreen_volumetricButton, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_image_src(ui_GrindScreen_volumetricButton, &ui_img_1424216268, LV_PART_MAIN | LV_STATE_DEFAULT);
