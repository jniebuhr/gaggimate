...
lv_obj_t * uic_MenuScreen_dials_weightText;
...
void ui_MenuScreen_screen_init(void)
{
    ...
    ui_MenuScreen_standbyButton = lv_imagebutton_create(ui_MenuScreen);
    lv_imagebutton_set_src(ui_MenuScreen_standbyButton, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_2044104741, NULL);
    ...
    lv_obj_remove_flag(ui_MenuScreen_contentPanel1, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_MenuScreen_btnBrew = lv_button_create(ui_MenuScreen_contentPanel1);
    ...
    lv_obj_remove_flag(ui_MenuScreen_btnBrew, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_image_src(ui_MenuScreen_btnBrew, &ui_img_979979123, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_MenuScreen_btnSteam = lv_button_create(ui_MenuScreen_contentPanel1);
    ...
    lv_obj_remove_flag(ui_MenuScreen_btnSteam, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_image_src(ui_MenuScreen_btnSteam, &ui_img_783005998, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_MenuScreen_waterBtn = lv_button_create(ui_MenuScreen_contentPanel1);
    ...
    lv_obj_remove_flag(ui_MenuScreen_waterBtn, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_image_src(ui_MenuScreen_waterBtn, &ui_img_545340440, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_MenuScreen_grindBtn = lv_button_create(ui_MenuScreen_contentPanel1);
    ...
    lv_obj_remove_flag(ui_MenuScreen_grindBtn, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    lv_obj_set_style_bg_image_src(ui_MenuScreen_grindBtn, &ui_img_363557387, LV_PART_MAIN | LV_STATE_DEFAULT);
