...
lv_obj_t * uic_StatusScreen_dials_weightText;
...
void ui_StatusScreen_screen_init(void)
{
    ...
    lv_obj_remove_flag(ui_StatusScreen, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_StatusScreen_ImgButton8 = lv_imagebutton_create(ui_StatusScreen);
    lv_imagebutton_set_src(ui_StatusScreen_ImgButton8, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_295763949, NULL);
    ...
    lv_obj_remove_flag(ui_StatusScreen_contentPanel2, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    ui_StatusScreen_pauseButton = lv_imagebutton_create(ui_StatusScreen_contentPanel2);
    lv_imagebutton_set_src(ui_StatusScreen_pauseButton, LV_IMAGEBUTTON_STATE_RELEASED, NULL, &ui_img_1456692430, NULL);
    ...
    ui_StatusScreen_Image7 = lv_image_create(ui_StatusScreen_contentPanel2);
    lv_image_set_src(ui_StatusScreen_Image7, &ui_img_1951499226);
    ...
    lv_obj_remove_flag(ui_StatusScreen_Image7, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_scale(ui_StatusScreen_Image7, 200);
    lv_image_set_inner_align(ui_StatusScreen_Image7, LV_IMAGE_ALIGN_TILE);
    ui_object_set_themeable_style_property(ui_StatusScreen_Image7, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMAGE_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ui_object_set_themeable_style_property(ui_StatusScreen_Image7, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_IMAGE_RECOLOR_OPA, _ui_theme_alpha_NiceWhite);

    ui_StatusScreen_Image8 = lv_image_create(ui_StatusScreen_contentPanel2);
    lv_image_set_src(ui_StatusScreen_Image8, &ui_img_360122106);
    ...
    lv_obj_remove_flag(ui_StatusScreen_Image8, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_image_set_scale(ui_StatusScreen_Image8, 200);
    lv_image_set_inner_align(ui_StatusScreen_Image8, LV_IMAGE_ALIGN_TILE);
    ui_object_set_themeable_style_property(ui_StatusScreen_Image8, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_IMAGE_RECOLOR,
                                           _ui_theme_color_NiceWhite);
    ...
    lv_obj_remove_flag(ui_StatusScreen_barContainer, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    ...
    if(lv_obj_get_style_pad_top(ui_StatusScreen_brewBar,
                                LV_PART_MAIN) > 0) lv_obj_set_style_pad_right(ui_StatusScreen_brewBar,
                                                                                  lv_obj_get_style_pad_right(ui_StatusScreen_brewBar, LV_PART_MAIN) + 1, LV_PART_MAIN);
    ...
    lv_obj_set_flex_align(ui_StatusScreen_labelContainer, LV_FLEX_ALIGN_SPACE_EVENLY, LV_FLEX_ALIGN_START,
                          LV_FLEX_ALIGN_CENTER);
    lv_obj_remove_flag(ui_StatusScreen_labelContainer, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
