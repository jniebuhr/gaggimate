...
typedef struct _objects_t {
    ...
    lv_obj_t *water_target_weight;
    lv_obj_t *water_label;
    lv_obj_t *water_down_weight_button;
    lv_obj_t *water_up_weight_button;
    lv_obj_t *target_symbol_weight;
    lv_obj_t *water_target_time;
    lv_obj_t *water_target_duration;
    lv_obj_t *water_down_duration_button;
    lv_obj_t *water_up_duration_button;
    lv_obj_t *target_symbol_time;
    lv_obj_t *mode_switch_water;
    lv_obj_t *obj15;
    lv_obj_t *obj16;
    lv_obj_t *temperature_image;
    lv_obj_t *water_down_temp_button;
    lv_obj_t *target_temp_water;
