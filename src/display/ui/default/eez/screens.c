...
static const char *screen_names[] = {
    "StandbyScreen", "BrewScreen",  "StatusScreen",    "MenuScreen",
...
static const char *object_names[] = {"standby_screen",
                                     ...
                                     "water_target_weight",
                                     "water_label",
                                     "water_down_weight_button",
                                     "water_up_weight_button",
                                     "target_symbol_weight",
                                     "water_target_time",
                                     "water_target_duration",
                                     "water_down_duration_button",
                                     "water_up_duration_button",
                                     "target_symbol_time",
                                     "mode_switch_water",
                                     "obj15",
                                     "obj16",
...
static void
event_handler_cb_brew_screen_remove_volumetric_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void
event_handler_cb_steam_screen_steam_down_temp_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_water_screen_water_start_button(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            ...
            assignBooleanProperty(flowState, 4, 3, value,
...
static void
event_handler_cb_water_screen_water_down_weight_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        action_on_water_lower(e);
    }
}

static void
event_handler_cb_water_screen_water_up_weight_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        action_on_water_raise(e);
    }
}

static void
event_handler_cb_water_screen_water_down_duration_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void
event_handler_cb_water_screen_water_up_duration_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_water_screen_mode_switch_water(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 16, 4, value,
                                  "Failed to assign Checked state");
        }
    }
    if (event == LV_EVENT_LONG_PRESSED) {
...
static void event_handler_cb_water_screen_obj15(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 17, 3, value,
                                  "Failed to assign Checked state");
        }
    }
}

static void event_handler_cb_water_screen_obj16(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 18, 3, value,
                                  "Failed to assign Checked state");
        }
    }
}
...
static void
event_handler_cb_water_screen_water_down_temp_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_grind_screen_mode_switch1(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 5, 4, value,
                                  "Failed to assign Checked state");
        }
    }
    if (event == LV_EVENT_LONG_PRESSED) {
...
static void event_handler_cb_grind_screen_obj27(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 6, 3, value,
                                  "Failed to assign Checked state");
        }
    }
}
...
static void event_handler_cb_grind_screen_obj28(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            bool value = lv_obj_has_state(ta, LV_STATE_CHECKED);
            assignBooleanProperty(flowState, 7, 3, value,
                                  "Failed to assign Checked state");
        }
    }
}
...
static void
event_handler_cb_grind_screen_grind_down_weight_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void
event_handler_cb_grind_screen_grind_up_weight_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void
event_handler_cb_grind_screen_grind_down_duration_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void
event_handler_cb_grind_screen_grind_up_duration_button(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void
event_handler_cb_new_profile_screen_new_profile_screen(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
void create_screen_standby_screen() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_standby_screen_standby_screen,
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_img_recolor(
                obj,
                lv_color_hex(
                    theme_colors[eez_flow_get_selected_theme_index()][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor_opa(obj, 255,
                                             LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        ...
        }
        {
            ...
            lv_obj_set_style_text_color(
                ...
                lv_color_hex(
                    theme_colors[eez_flow_get_selected_theme_index()][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_text_font(obj, &lv_font_montserrat_34,
                                       LV_PART_MAIN | LV_STATE_DEFAULT);
                                   ...
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_border_color(
                        obj,
                        lv_color_hex(
                            theme_colors[eez_flow_get_selected_theme_index()]
                                        [1]),
                        LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_width(
                        obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_img_recolor(
                        obj,
                        lv_color_hex(
                            theme_colors[eez_flow_get_selected_theme_index()]
                    ...
                    lv_obj_set_style_img_recolor_opa(
                        obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
                }
                {
                    // bluetoothIcon
                    lv_obj_t *obj = lv_img_create(parent_obj);
...
void tick_screen_standby_screen() {
    ...
    (void)flowState;
    {
        bool new_val = evalBooleanProperty(flowState, 2, 3,
    ...
    }
    {
        const char *new_val = evalTextProperty(
            flowState, 3, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 3, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 4, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.standby_icons, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 5, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 6, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 7, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 8, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 8, 3,
                                           "Failed to evaluate Hidden flag");
...
void create_screen_brew_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_brew_screen_brew_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(
        obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][1]),
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 12,
                                     &state->brew_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        {
            ...
            lv_obj_set_style_bg_color(
                obj,
                lv_color_hex(
                    theme_colors[eez_flow_get_selected_theme_index()][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
            ...
            lv_obj_set_style_radius(obj, 180, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL,
                                      &img_play_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_brew_screen_start_button,
                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_img_recolor(
                ...
                }
                {
                                                          ...
                                                          LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj, event_handler_cb_brew_screen_mode_switch,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(
                            ...
                            lv_obj_set_style_flex_main_place(
                                obj, LV_FLEX_ALIGN_SPACE_AROUND,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_flex_cross_place(
                                obj, LV_FLEX_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
                                ...
                                obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                ...
                                }
                                {
                                    ...
                                    lv_obj_set_style_text_font(
                                        obj, &lv_font_montserrat_24,
                                        LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_obj_set_style_text_align(
                                        obj, LV_TEXT_ALIGN_CENTER,
                                        LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_label_set_text(obj, "");
                                }
                            }
                        }
                        {
                            ...
                            lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_COLUMN,
                                                       LV_PART_MAIN |
                                                           LV_STATE_DEFAULT);
                            lv_obj_set_style_flex_main_place(
                                obj, LV_FLEX_ALIGN_SPACE_EVENLY,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_flex_cross_place(
                                obj, LV_FLEX_ALIGN_CENTER,
                                LV_PART_MAIN | LV_STATE_DEFAULT);
                                ...
                                obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    ...
                                    lv_obj_set_style_text_color(
                                        ...
                                        LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_obj_set_style_text_font(
                                        obj, &lv_font_montserrat_18,
                                        LV_PART_MAIN | LV_STATE_DEFAULT);
                                    lv_label_set_text_static(
                                        obj, "Selected profile");
                                }
                                {
                                    lv_obj_t *obj = lv_obj_create(parent_obj);
                                        ...
                                        LV_PART_MAIN | LV_STATE_DEFAULT);
                                    {
                                        lv_obj_t *parent_obj = obj;
                                        {
                                            // profileSelectButton
                                            lv_obj_t *obj =
                                                lv_imgbtn_create(parent_obj);
                                            objects.profile_select_button = obj;
                                            lv_obj_set_pos(obj, 0, 0);
                                            lv_obj_set_size(
                                                obj, LV_SIZE_CONTENT, 64);
                                            lv_imgbtn_set_src(
                                                obj, LV_IMGBTN_STATE_RELEASED,
                                                NULL, &img_dropdown_bar_40x40,
                                                NULL);
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_profile_select_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                                        ...
                                        }
                                        {
                                            ...
                                            lv_imgbtn_set_src(
                                                obj, LV_IMGBTN_STATE_RELEASED,
                                                NULL, &img_settings_40x40,
                                                NULL);
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_settings_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_img_recolor(
                                                obj,
                                                lv_color_hex(
                        ...
                        }
                        {
                            ...
                            lv_obj_set_style_flex_track_place(
                                ...
                                LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_pad_row(
                                obj, 20, LV_PART_MAIN | LV_STATE_DEFAULT);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
                                    // tempContainer
                                        ...
                                        LV_PART_MAIN | LV_STATE_DEFAULT);
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_imgbtn_set_src(
                                                obj, LV_IMGBTN_STATE_RELEASED,
                                                NULL, &img_minus_small_40x40,
                                                NULL);
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_down_temp_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                                        ...
                                        }
                                        {
                                            ...
                                            lv_imgbtn_set_src(
                                                obj, LV_IMGBTN_STATE_RELEASED,
                                                NULL, &img_plus_small_40x40,
                                                NULL);
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_up_temp_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                                ...
                                }
                                {
                                                 ...
                                                 LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_up_duration_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_down_duration_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                                ...
                                }
                                {
                                                 ...
                                                 LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                                    {
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_up_weight_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_down_weight_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                                        ...
                                        }
                                        {
                                            ...
                                            lv_obj_t *obj =
                                                lv_imgbtn_create(parent_obj);
                                            objects.remove_volumetric_button =
                                                obj;
                                            lv_obj_set_pos(obj, 140, 0);
                                            lv_obj_set_size(obj, 40, 40);
                                            lv_imgbtn_set_src(
                                                obj, LV_IMGBTN_STATE_RELEASED,
                                                NULL,
                                                &img_clock_future_past_40x40,
                                                NULL);
                                            lv_obj_add_event_cb(
                                                obj,
                                                event_handler_cb_brew_screen_remove_volumetric_button,
                                                LV_EVENT_ALL, flowState);
                                            lv_obj_set_style_align(
                                                obj, LV_ALIGN_CENTER,
                                                LV_PART_MAIN |
                ...
                }
                {
                                                          ...
                                                          LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_disk_30x30, NULL);
                            lv_obj_add_event_cb(
                                obj, event_handler_cb_brew_screen_save_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                                   LV_PART_MAIN |
                                                       LV_STATE_DEFAULT);
                            ...
                            lv_obj_set_style_blend_mode(
                                obj, LV_BLEND_MODE_NORMAL,
                                LV_PART_MAIN | LV_STATE_DISABLED);
                            lv_obj_set_style_img_opa(
                                obj, 125, LV_PART_MAIN | LV_STATE_DISABLED);
                        }
                        {
                            // acceptButton
                            lv_obj_t *obj = lv_imgbtn_create(parent_obj);
                            ...
                            lv_obj_set_size(obj, 40, 40);
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_check_40x40, NULL);
                            lv_obj_add_event_cb(
                                obj, event_handler_cb_brew_screen_accept_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                                   LV_PART_MAIN |
                                                       LV_STATE_DEFAULT);
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, 30, 30);
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_floppy_disks_30x30,
                                              NULL);
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_brew_screen_save_as_new_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                                   LV_PART_MAIN |
                                                       LV_STATE_DEFAULT);
...
void tick_screen_brew_screen() {
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 3, 3, "Failed to evaluate Text in Label widget");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 4, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.start_button, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 7, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.bluetooth_scale_icon, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.bluetooth_scale_icon;
            if (new_val) {
                lv_obj_add_flag(objects.bluetooth_scale_icon,
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.bluetooth_scale_icon,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 8, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.flow_prediction_icon, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.flow_prediction_icon;
            if (new_val) {
                lv_obj_add_flag(objects.flow_prediction_icon,
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.flow_prediction_icon,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 10, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.profile_info, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 16, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 18, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 22, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.brew_target_time_container,
                                       LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.brew_target_time_container;
            if (new_val) {
                lv_obj_add_flag(objects.brew_target_time_container,
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.brew_target_time_container,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 27, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.brew_target_weight_container,
                                       LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.brew_target_weight_container;
            if (new_val) {
                lv_obj_add_flag(objects.brew_target_weight_container,
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.brew_target_weight_container,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 28, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 33, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 34, 3,
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 36, 3,
                                           "Failed to evaluate Disabled state");
        bool cur_val =
            lv_obj_has_state(objects.save_as_new_button, LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.save_as_new_button;
            if (new_val) {
                lv_obj_add_state(objects.save_as_new_button, LV_STATE_DISABLED);
            } else {
                lv_obj_clear_state(objects.save_as_new_button,
                                   LV_STATE_DISABLED);
            }
            tick_value_change_obj = NULL;
        }
...
void create_screen_status_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_status_screen_status_screen,
                        LV_EVENT_ALL, flowState);
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 23,
                                     &state->status_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
        }
        {
                ...
                LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 40, 40);
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL,
                                      &img_pause_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_status_screen_pause_button,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 40, 40);
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL,
                                      &img_check_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_status_screen_check_button,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    ...
                    lv_obj_set_style_text_color(
                        ...
                        lv_color_hex(
                            theme_colors[eez_flow_get_selected_theme_index()]
                                        [3]),
                        LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_text_opa(obj, 408,
                                              LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, "");
                }
                {
                ...
                }
                {
                    ...
                    lv_obj_set_style_flex_main_place(
                        obj, LV_FLEX_ALIGN_SPACE_EVENLY,
                        LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_flex_cross_place(obj, LV_FLEX_ALIGN_START,
                                                      LV_PART_MAIN |
                                                          LV_STATE_DEFAULT);
                    lv_obj_set_style_flex_track_place(obj, LV_FLEX_ALIGN_CENTER,
                                                      LV_PART_MAIN |
                                                          LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_style_bg_color(
                                ...
                                LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_opa(
                                obj, 408, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_flex_grow(
                                obj, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_color(
                                obj,
                ...
                }
                {
                    ...
                    lv_obj_set_style_text_font(obj, &lv_font_montserrat_14,
                                               LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_flex_grow(obj, 4,
                                               LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_label_set_text(obj, "");
                }
                {
...
void tick_screen_status_screen() {
    ...
    void *flowState = getFlowState(0, 2);
    (void)flowState;
    tick_user_widget_dials(getFlowState(flowState, 0), 23,
                           &state->status_dials);
    {
        const char *new_val = evalTextProperty(
            flowState, 3, 4, "Failed to evaluate Text in Label widget");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 3, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.target_duration_1, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.target_duration_1;
            if (new_val) {
                lv_obj_add_flag(objects.target_duration_1, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.target_duration_1,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 4, 4, "Failed to evaluate Text in Label widget");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 4, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.target_weight_2, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.target_weight_2;
            if (new_val) {
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 5, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 9, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.pause_button, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 10, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.check_button, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 14, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.bar_container, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    }
    {
        int32_t new_val = evalIntegerProperty(
            flowState, 15, 3, "Failed to evaluate Value in Bar widget");
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 16, 4, "Failed to evaluate Text in Label widget");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 16, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.phase_progress, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.phase_progress;
            if (new_val) {
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 17, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 17, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.process_volume, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.process_volume;
            if (new_val) {
...
void create_screen_menu_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_menu_screen_menu_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(
        obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][1]),
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 34,
                                     &state->menu_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
                                       ...
                                       LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_add_event_cb(obj,
                                        event_handler_cb_menu_screen_btn_brew,
                                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_mug_hot_alt_80x80,
                                                LV_PART_MAIN |
                                                    LV_STATE_DEFAULT);
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(obj,
                                        event_handler_cb_menu_screen_btn_steam,
                                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(
                        obj, &img_wind_80x80, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_recolor(
                        obj,
                        lv_color_hex(
                            theme_colors[eez_flow_get_selected_theme_index()]
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(obj,
                                        event_handler_cb_menu_screen_btn_water,
                                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_raindrops_80x80,
                                                LV_PART_MAIN |
                                                    LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_recolor(
                        obj,
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(obj,
                                        event_handler_cb_menu_screen_btn_grind,
                                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_coffee_bean_80x80,
                                                LV_PART_MAIN |
                                                    LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_recolor(
                        obj,
...
void create_screen_menu_screen_new() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_menu_screen_new_menu_screen_new,
                        LV_EVENT_ALL, flowState);
        ...
        LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 45,
                                     &state->new_menu_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
        ...
        }
        {
                                       ...
                                       LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_menu_screen_new_btn_brew_1,
                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_mug_hot_alt_80x80,
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_menu_screen_new_btn_steam_1,
                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_menu_screen_new_btn_water_1,
                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_raindrops_80x80,
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_menu_screen_new_btn_grind_1,
                        LV_EVENT_ALL, flowState);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_coffee_bean_80x80,
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, 120, 120);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_menu_screen_new_btn_settings_1,
                        LV_EVENT_ALL, flowState);
                    lv_obj_add_flag(obj, LV_OBJ_FLAG_ADV_HITTEST |
                                             LV_OBJ_FLAG_HIDDEN);
                    lv_obj_set_style_bg_opa(obj, 0,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_src(obj, &img_settings_80x80,
                                                LV_PART_MAIN |
                                                    LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_img_recolor(
                        obj,
        ...
        }
        {
            ...
            lv_obj_set_style_flex_cross_place(obj, LV_FLEX_ALIGN_CENTER,
                                              LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_pad_column(obj, 20,
                                        LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_menu_screen_new_info_btn,
                                LV_EVENT_ALL, flowState);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj,
                                event_handler_cb_menu_screen_new_standby_btn,
                                LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
...
void tick_screen_menu_screen_new() {
    ...
    void *flowState = getFlowState(0, 4);
    (void)flowState;
    tick_user_widget_dials(getFlowState(flowState, 0), 45,
                           &state->new_menu_dials);
    {
        bool new_val = evalBooleanProperty(flowState, 6, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 11, 3,
                                           "Failed to evaluate Hidden flag");
...
void create_screen_steam_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_steam_screen_steam_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE |
                               LV_OBJ_FLAG_GESTURE_BUBBLE |
                               LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE);
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 56,
                                     &state->steam_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                       LV_OBJ_FLAG_SCROLL_CHAIN_HOR |
                                       LV_OBJ_FLAG_SCROLL_CHAIN_VER |
                ...
                }
                {
                                           ...
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_steam_screen_steam_down_temp_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_steam_screen_steam_up_temp_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
...
void tick_screen_steam_screen() {
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 6, 3, "Failed to evaluate Text in Label widget");
...
void create_screen_water_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_water_screen_water_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE |
                               LV_OBJ_FLAG_GESTURE_BUBBLE |
                               LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE);
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 67,
                                     &state->water_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                       LV_OBJ_FLAG_SCROLL_CHAIN_HOR |
                                       LV_OBJ_FLAG_SCROLL_CHAIN_VER |
        ...
        }
        {
                                   ...
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL,
                                      &img_play_40x40, NULL);
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_CHECKED_RELEASED,
                                      NULL, &img_pause_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_water_screen_water_start_button,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                }
                {
                    // waterTargetWeight
                    lv_obj_t *obj = lv_obj_create(parent_obj);
                    objects.water_target_weight = obj;
                                           ...
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        {
                            // waterDownWeightButton
                            lv_obj_t *obj = lv_imgbtn_create(parent_obj);
                            objects.water_down_weight_button = obj;
                            lv_obj_set_pos(obj, -90, 0);
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_water_screen_water_down_weight_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        }
                        {
                            // waterUpWeightButton
                            lv_obj_t *obj = lv_imgbtn_create(parent_obj);
                            objects.water_up_weight_button = obj;
                            lv_obj_set_pos(obj, 90, 0);
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, 40);
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_plus_small_40x40,
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_water_screen_water_up_weight_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        }
                        {
                            // targetSymbolWeight
                            lv_obj_t *obj = lv_img_create(parent_obj);
                            objects.target_symbol_weight = obj;
                ...
                }
                {
                                           ...
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            // waterTargetDuration
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.water_target_duration = obj;
                        ...
                        {
                            // waterDownDurationButton
                            lv_obj_t *obj = lv_imgbtn_create(parent_obj);
                            objects.water_down_duration_button = obj;
                            lv_obj_set_pos(obj, -90, 0);
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, 40);
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_minus_small_40x40,
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_water_screen_water_down_duration_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        {
                            // waterUpDurationButton
                            lv_obj_t *obj = lv_imgbtn_create(parent_obj);
                            objects.water_up_duration_button = obj;
                            lv_obj_set_pos(obj, 90, 0);
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, 40);
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_plus_small_40x40,
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_water_screen_water_up_duration_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        }
                        {
                            // targetSymbolTime
                            lv_obj_t *obj = lv_img_create(parent_obj);
                            objects.target_symbol_time = obj;
                            lv_obj_set_pos(obj, -150, 0);
                            lv_obj_set_size(obj, 40, 40);
                            lv_img_set_src(obj, &img_clock_40x40);
                            lv_obj_clear_flag(obj,
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT,
                                            LV_SIZE_CONTENT);
                            lv_img_set_src(obj, &img_infinity);
                            add_style_images_theme_color(obj);
                        }
                    }
                }
                {
                    ...
                    lv_obj_set_style_pad_bottom(
                        obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_water_screen_mode_switch_water,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                               LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_radius(obj, 10,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_bg_color(
                        obj,
                        lv_color_hex(
                    ...
                    lv_obj_set_style_border_side(obj, LV_BORDER_SIDE_FULL,
                                                 LV_PART_MAIN |
                                                     LV_STATE_DEFAULT);
                    lv_obj_set_style_border_width(
                        obj, 2, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_layout(obj, LV_LAYOUT_FLEX,
                                            LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_flex_flow(obj, LV_FLEX_FLOW_ROW,
                                               LV_PART_MAIN | LV_STATE_DEFAULT);
                        ...
                        LV_PART_MAIN | LV_STATE_CHECKED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, 40);
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_equality_40x40, NULL);
                            lv_obj_add_event_cb(
                                obj, event_handler_cb_water_screen_obj15,
                                LV_EVENT_ALL, flowState);
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT,
                                            LV_SIZE_CONTENT);
                            lv_obj_add_event_cb(
                                obj, event_handler_cb_water_screen_obj16,
                                LV_EVENT_ALL, flowState);
                ...
                }
                {
                                           ...
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_water_screen_water_down_temp_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_water_screen_water_up_temp_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
...
void delete_screen_water_screen() {
    ...
    objects.water_target_weight = 0;
    objects.water_label = 0;
    objects.water_down_weight_button = 0;
    objects.water_up_weight_button = 0;
    objects.target_symbol_weight = 0;
    objects.water_target_time = 0;
    objects.water_target_duration = 0;
    objects.water_down_duration_button = 0;
    objects.water_up_duration_button = 0;
    objects.target_symbol_time = 0;
    objects.obj17 = 0;
    objects.mode_switch_water = 0;
    objects.obj15 = 0;
    objects.obj16 = 0;
    objects.temperature_image = 0;
    objects.water_down_temp_button = 0;
    objects.target_temp_water = 0;
...
void tick_screen_water_screen() {
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 5, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.water_target_weight, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.water_target_weight;
            if (new_val) {
                lv_obj_add_flag(objects.water_target_weight,
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.water_target_weight,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(
            flowState, 6, 3, "Failed to evaluate Text in Label widget");
        const char *cur_val = lv_label_get_text(objects.water_label);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.water_label;
            lv_label_set_text(objects.water_label, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 10, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.water_target_time, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.water_target_time;
            if (new_val) {
                lv_obj_add_flag(objects.water_target_time, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.water_target_time,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 11, 4, "Failed to evaluate Text in Label widget");
        const char *cur_val = lv_label_get_text(objects.water_target_duration);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.water_target_duration;
            lv_label_set_text(objects.water_target_duration, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 11, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.water_target_duration, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.water_target_duration;
            if (new_val) {
                lv_obj_add_flag(objects.water_target_duration,
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.water_target_duration,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 15, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 16, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.mode_switch_water, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.mode_switch_water;
            if (new_val) {
                lv_obj_add_flag(objects.mode_switch_water, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(objects.mode_switch_water,
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 16, 4,
                                           "Failed to evaluate Checked state");
        bool cur_val =
            lv_obj_has_state(objects.mode_switch_water, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.mode_switch_water;
            if (new_val) {
                lv_obj_add_state(objects.mode_switch_water, LV_STATE_CHECKED);
            } else {
                lv_obj_clear_state(objects.mode_switch_water, LV_STATE_CHECKED);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        ...
        if (new_val != cur_val) {
            ...
            if (new_val) {
                lv_obj_add_state(objects.obj15, LV_STATE_CHECKED);
            } else {
                lv_obj_clear_state(objects.obj15, LV_STATE_CHECKED);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(
            flowState, 18, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 18, 3,
                                           "Failed to evaluate Checked state");
        bool cur_val = lv_obj_has_state(objects.obj16, LV_STATE_CHECKED);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj16;
            if (new_val) {
                lv_obj_add_state(objects.obj16, LV_STATE_CHECKED);
            } else {
                lv_obj_clear_state(objects.obj16, LV_STATE_CHECKED);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(
            flowState, 22, 3, "Failed to evaluate Text in Label widget");
        const char *cur_val = lv_label_get_text(objects.target_temp_water);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.target_temp_water;
            lv_label_set_text(objects.target_temp_water, new_val);
            tick_value_change_obj = NULL;
        }
    }
}
...
void create_screen_profile_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_profile_screen_profile_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(
        obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][1]),
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 78,
                                     &state->profile_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL,
                                      &img_check_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_profile_screen_select_profile,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                               LV_OBJ_FLAG_SCROLL_CHAIN_HOR |
                                               LV_OBJ_FLAG_SCROLL_CHAIN_VER |
                ...
                }
                {
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, 64);
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL,
                                      &img_angle_left_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_profile_screen_previous_profile,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                               LV_OBJ_FLAG_SCROLL_CHAIN_HOR |
                                               LV_OBJ_FLAG_SCROLL_CHAIN_VER |
                    ...
                    lv_obj_set_style_img_recolor_opa(
                        obj, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_img_opa(obj, 125,
                                             LV_PART_MAIN | LV_STATE_DISABLED);
                }
                {
                    // nextProfile
                    ...
                    lv_obj_set_size(obj, LV_SIZE_CONTENT, 64);
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL,
                                      &img_angle_right_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_profile_screen_next_profile,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                               LV_OBJ_FLAG_SCROLL_CHAIN_HOR |
                                               LV_OBJ_FLAG_SCROLL_CHAIN_VER |
...
void tick_screen_profile_screen() {
    ...
    void *flowState = getFlowState(0, 7);
    (void)flowState;
    tick_user_widget_dials(getFlowState(flowState, 0), 78,
                           &state->profile_dials);
    {
        const char *new_val = evalTextProperty(
            flowState, 3, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 12, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 16, 3, "Failed to evaluate Text in Label widget");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 18, 3,
                                           "Failed to evaluate Disabled state");
        bool cur_val =
            lv_obj_has_state(objects.previous_profile, LV_STATE_DISABLED);
        if (new_val != cur_val) {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 19, 3,
                                           "Failed to evaluate Disabled state");
        bool cur_val =
            lv_obj_has_state(objects.next_profile, LV_STATE_DISABLED);
        if (new_val != cur_val) {
...
void create_screen_grind_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_grind_screen_grind_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICK_FOCUSABLE |
                               LV_OBJ_FLAG_GESTURE_BUBBLE |
                               LV_OBJ_FLAG_SNAPPABLE | LV_OBJ_FLAG_SCROLLABLE);
        ...
        LV_PART_MAIN | LV_STATE_CHECKED);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 89,
                                     &state->grind_dials);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                       LV_OBJ_FLAG_SCROLL_CHAIN_HOR |
                                       LV_OBJ_FLAG_SCROLL_CHAIN_VER |
                                   ...
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                ...
                }
                {
                    ...
                    lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_CHECKED_RELEASED,
                                      NULL, &img_pause_40x40, NULL);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_grind_screen_grind_start_button,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                ...
                }
                {
                    ...
                    lv_obj_set_style_pad_bottom(
                        obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_add_event_cb(
                        obj, event_handler_cb_grind_screen_mode_switch1,
                        LV_EVENT_ALL, flowState);
                    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE |
                                               LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                    lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                        ...
                        LV_PART_MAIN | LV_STATE_CHECKED);
                    {
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED,
                                              NULL, &img_equality_40x40, NULL);
                            lv_obj_add_event_cb(
                                obj, event_handler_cb_grind_screen_obj27,
                                LV_EVENT_ALL, flowState);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID,
                                                   LV_PART_MAIN |
                                                       LV_STATE_DEFAULT);
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT,
                                            LV_SIZE_CONTENT);
                            lv_obj_add_event_cb(
                                obj, event_handler_cb_grind_screen_obj28,
                                LV_EVENT_ALL, flowState);
                            lv_obj_set_style_align(obj, LV_ALIGN_RIGHT_MID,
                                                   LV_PART_MAIN |
                                                       LV_STATE_DEFAULT);
                ...
                }
                {
                                           ...
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_grind_screen_grind_down_weight_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_grind_screen_grind_up_weight_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                ...
                }
                {
                                           ...
                                           LV_PART_MAIN | LV_STATE_DEFAULT);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_grind_screen_grind_down_duration_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
                        ...
                        }
                        {
                            ...
                            lv_obj_add_event_cb(
                                obj,
                                event_handler_cb_grind_screen_grind_up_duration_button,
                                LV_EVENT_ALL, flowState);
                            lv_obj_clear_flag(obj,
                                              LV_OBJ_FLAG_SCROLL_WITH_ARROW);
                            lv_obj_set_scrollbar_mode(obj,
...
void tick_screen_grind_screen() {
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 5, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.mode_switch1, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 5, 4,
                                           "Failed to evaluate Checked state");
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 7, 4, "Failed to evaluate Text in Label widget");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 8, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.target_weight, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 13, 3,
                                           "Failed to evaluate Hidden flag");
...
void create_screen_info_screen() {
    ...
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj, event_handler_cb_info_screen_info_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    lv_obj_set_style_bg_color(
        obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][1]),
                           ...
                           LV_PART_MAIN | LV_STATE_DEFAULT);
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_style_border_width(obj, 0,
                                          LV_PART_MAIN | LV_STATE_DEFAULT);
            create_user_widget_dials(obj, getFlowState(flowState, 0), 100,
                                     &state->dials1_state);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_add_event_cb(obj,
                                event_handler_cb_info_screen_info_menu_icon,
                                LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
...
void tick_screen_info_screen() {
    ...
    void *flowState = getFlowState(0, 9);
    (void)flowState;
    tick_user_widget_dials(getFlowState(flowState, 0), 100,
                           &state->dials1_state);
    {
        bool new_val = evalBooleanProperty(flowState, 4, 3,
                                           "Failed to evaluate Hidden flag");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 5, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.bluetooth_icon_1, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 6, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val =
            lv_obj_has_flag(objects.update_icon_1, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 7, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 12, 4, "Failed to evaluate Text in Label widget");
...
void create_screen_new_profile_screen() {
    ...
    lv_obj_set_size(obj, 480, 480);
    lv_obj_add_event_cb(obj,
                        event_handler_cb_new_profile_screen_new_profile_screen,
                        LV_EVENT_ALL, flowState);
    lv_obj_set_style_bg_color(
        obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][1]),
        LV_PART_MAIN | LV_STATE_DEFAULT);
    {
                        ...
                        lv_obj_t *parent_obj = obj;
                        {
                            ...
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                                   LV_PART_MAIN |
                                                       LV_STATE_DEFAULT);
                            lv_obj_set_style_radius(
                                obj, 30, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_clip_corner(
                                obj, true, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_color(
                                obj,
                                lv_color_hex(
                                    theme_colors
                        ...
                        }
                        {
                            ...
                            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                                   LV_PART_MAIN |
                                                       LV_STATE_DEFAULT);
                            lv_obj_set_style_radius(
                                obj, 15, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_bg_color(
                                obj,
                                lv_color_hex(
                                    theme_colors
        ...
        }
        {
            ...
            lv_obj_set_style_radius(obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
            {
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    lv_obj_set_style_pad_bottom(
                        obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_left(obj, 15,
                                              LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_right(obj, 15,
                                               LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_row(obj, 10,
                                             LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_pad_column(
                        obj, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
                    lv_obj_set_style_border_width(
        ...
        }
        {
            ...
            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL, &img_gallery,
                              NULL);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor(
        ...
        }
        {
            ...
            lv_obj_set_pos(obj, 25, -175);
            lv_obj_set_size(obj, LV_SIZE_CONTENT, 32);
            lv_imgbtn_set_src(obj, LV_IMGBTN_STATE_RELEASED, NULL, &img_list,
                              NULL);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor(
                ...
                lv_color_hex(
                    theme_colors[eez_flow_get_selected_theme_index()][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor_opa(obj, 100,
                                             LV_PART_MAIN | LV_STATE_DEFAULT);
        }
    }
...
void create_user_widget_dials(lv_obj_t *parent_obj, void *flowState,
                              int startWidgetIndex,
                              user_widget_dials_state_t *state) {
    (void)flowState;
    ...
    lv_obj_t *obj = parent_obj;
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_size(obj, 500, 500);
            {
                ...
                lv_meter_set_scale_ticks(
                    obj, scale, 25, 10, 25,
                    lv_color_hex(
                        theme_colors[eez_flow_get_selected_theme_index()][5]));
                lv_meter_set_scale_major_ticks(obj, scale, 0, 0, 0,
                                               lv_color_hex(0x000000), 0);
                lv_meter_set_scale_range(obj, scale, 0, 160, 120, 120);
                {
                    state->indicator = lv_meter_add_needle_img(
                        obj, scale, &img_indicator_small, -233, 0);
                }
                {
                    lv_meter_indicator_t *indicator = lv_meter_add_scale_lines(
                        obj, scale,
                        lv_color_hex(
                            theme_colors[eez_flow_get_selected_theme_index()]
                                        [6]),
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_dials_temp_gauge,
                                LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj,
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 500, 500);
            {
                ...
                {
                    state->indicator2 = lv_meter_add_needle_img(
                        obj, scale, &img_indicator_small, -233, 0);
                }
                {
                    lv_meter_indicator_t *indicator = lv_meter_add_scale_lines(
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_dials_temp_gauge_full,
                                LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj, LV_OBJ_FLAG_CLICKABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, 500, 500);
            {
                ...
                {
                    state->indicator4 = lv_meter_add_needle_img(
                        obj, scale, &img_indicator_small, -233, 0);
                }
                {
                    lv_meter_indicator_t *indicator = lv_meter_add_scale_lines(
            ...
            lv_obj_add_event_cb(obj, event_handler_cb_dials_pressure_gauge,
                                LV_EVENT_ALL, flowState);
            lv_obj_clear_flag(obj,
                              LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);
            lv_obj_set_scrollbar_mode(obj, LV_SCROLLBAR_MODE_OFF);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_power_40x40);
            lv_obj_add_event_cb(obj, event_handler_cb_dials_standby_icon,
                                LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
            lv_img_set_src(obj, &img_angle_up_40x40);
            lv_obj_add_event_cb(obj, event_handler_cb_dials_menu_icon,
                                LV_EVENT_ALL, flowState);
            lv_obj_add_flag(obj, LV_OBJ_FLAG_CLICKABLE);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        }
        {
            ...
            lv_img_set_src(obj, &img_thermometer_half_40x40);
            lv_img_set_zoom(obj, 150);
            lv_obj_add_event_cb(obj, event_handler_cb_dials_temp_icon,
                                LV_EVENT_ALL, flowState);
            lv_obj_set_style_align(obj, LV_ALIGN_CENTER,
                                   LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor(
                obj,
                lv_color_hex(
                    theme_colors[eez_flow_get_selected_theme_index()][6]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor_opa(obj, 255,
                                             LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor(
                obj,
                lv_color_hex(
                    theme_colors[eez_flow_get_selected_theme_index()][2]),
                LV_PART_MAIN | LV_STATE_CHECKED);
            lv_obj_set_style_img_opa(obj, 125,
                                     LV_PART_MAIN | LV_STATE_DISABLED);
        }
        {
            ...
            lv_obj_set_style_img_recolor(
                obj,
                lv_color_hex(
                    theme_colors[eez_flow_get_selected_theme_index()][7]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
            lv_obj_set_style_img_recolor_opa(obj, 255,
                                             LV_PART_MAIN | LV_STATE_DEFAULT);
        }
...
void tick_user_widget_dials(void *flowState, int startWidgetIndex,
                            user_widget_dials_state_t *state) {
    (void)flowState;
    (void)startWidgetIndex;
    (void)state;
    {
        if (state->indicator) {
            int32_t new_val = evalIntegerProperty(
                flowState, 1, 4, "Failed to evaluate Value in Meter widget");
    ...
    }
    {
        if (state->indicator1) {
            int32_t new_val = evalIntegerProperty(
                flowState, 1, 5,
                "Failed to evaluate End value in Meter widget");
            ...
            if (new_val != cur_val) {
                ...
                lv_meter_set_indicator_end_value(
                    ((lv_obj_t **)&objects)[startWidgetIndex + 0],
                    state->indicator1, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 1, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 0], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 0];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 0],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 0],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        if (state->indicator2) {
            int32_t new_val = evalIntegerProperty(
                flowState, 0, 4, "Failed to evaluate Value in Meter widget");
            int32_t cur_val = state->indicator2->start_value;
            if (new_val != cur_val) {
                tick_value_change_obj =
                    ((lv_obj_t **)&objects)[startWidgetIndex + 1];
                lv_meter_set_indicator_value(
                    ((lv_obj_t **)&objects)[startWidgetIndex + 1],
                    state->indicator2, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        if (state->indicator3) {
            ...
            if (new_val != cur_val) {
                ...
                lv_meter_set_indicator_end_value(
                    ((lv_obj_t **)&objects)[startWidgetIndex + 1],
                    state->indicator3, new_val);
                tick_value_change_obj = NULL;
            }
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 0, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 1], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 1];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 1],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 1],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        if (state->indicator4) {
            int32_t new_val = evalIntegerProperty(
                flowState, 2, 4, "Failed to evaluate Value in Meter widget");
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 2, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 2], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 2];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 2],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 2],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 3, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 3], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 3];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 3],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 3],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 4, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 4], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 4];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 4],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 4],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 5, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 5], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 5];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 5],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 5],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 5, 5,
                                           "Failed to evaluate Disabled state");
        bool cur_val = lv_obj_has_state(
            ((lv_obj_t **)&objects)[startWidgetIndex + 5], LV_STATE_DISABLED);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 5];
            if (new_val) {
    ...
    }
    {
        bool new_val = evalBooleanProperty(flowState, 6, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 6], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 6];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 6],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 6],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(
            flowState, 7, 4, "Failed to evaluate Text in Label widget");
        const char *cur_val =
            lv_label_get_text(((lv_obj_t **)&objects)[startWidgetIndex + 7]);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 7];
            lv_label_set_text(((lv_obj_t **)&objects)[startWidgetIndex + 7],
                              new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 7, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 7], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 7];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 7],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 7],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(
            flowState, 8, 4, "Failed to evaluate Text in Label widget");
        const char *cur_val =
            lv_label_get_text(((lv_obj_t **)&objects)[startWidgetIndex + 8]);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 8];
            lv_label_set_text(((lv_obj_t **)&objects)[startWidgetIndex + 8],
                              new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 8, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 8], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 8];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 8],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 8],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    ...
    {
        const char *new_val = evalTextProperty(
            flowState, 9, 4, "Failed to evaluate Text in Label widget");
        const char *cur_val =
            lv_label_get_text(((lv_obj_t **)&objects)[startWidgetIndex + 9]);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 9];
            lv_label_set_text(((lv_obj_t **)&objects)[startWidgetIndex + 9],
                              new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 9, 3,
                                           "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(
            ((lv_obj_t **)&objects)[startWidgetIndex + 9], LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj =
                ((lv_obj_t **)&objects)[startWidgetIndex + 9];
            if (new_val) {
                lv_obj_add_flag(((lv_obj_t **)&objects)[startWidgetIndex + 9],
                                LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_clear_flag(((lv_obj_t **)&objects)[startWidgetIndex + 9],
                                  LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
...
create_screen_func_t create_screen_funcs[] = {
    create_screen_standby_screen,     create_screen_brew_screen,
    create_screen_status_screen,      create_screen_menu_screen,
    create_screen_menu_screen_new,    create_screen_steam_screen,
    create_screen_water_screen,       create_screen_profile_screen,
    create_screen_grind_screen,       create_screen_info_screen,
...
delete_screen_func_t delete_screen_funcs[] = {
    delete_screen_standby_screen,     delete_screen_brew_screen,
    delete_screen_status_screen,      delete_screen_menu_screen,
    delete_screen_menu_screen_new,    delete_screen_steam_screen,
    delete_screen_water_screen,       delete_screen_profile_screen,
    delete_screen_grind_screen,       delete_screen_info_screen,
...
tick_screen_func_t tick_screen_funcs[] = {
    tick_screen_standby_screen,     tick_screen_brew_screen,
    tick_screen_status_screen,      tick_screen_menu_screen,
    tick_screen_menu_screen_new,    tick_screen_steam_screen,
    tick_screen_water_screen,       tick_screen_profile_screen,
    tick_screen_grind_screen,       tick_screen_info_screen,
    tick_screen_new_profile_screen,
};
...
static const char *style_names[] = {"Text-theme-color", "images-theme-color",
                                    "screen-theme-color"};
...
void change_color_theme(uint32_t theme_index) {
    {
        if (objects.standby_screen)
            lv_obj_set_style_bg_color(
                objects.standby_screen,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj1)
            lv_obj_set_style_img_recolor(
                objects.obj1, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.touch_icon)
            lv_obj_set_style_img_recolor(
                objects.touch_icon, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.time)
            lv_obj_set_style_text_color(
                objects.time, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.wifi_icon)
            lv_obj_set_style_border_color(
                objects.wifi_icon, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.wifi_icon)
            lv_obj_set_style_img_recolor(
                objects.wifi_icon, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        if (objects.update_icon)
            lv_obj_set_style_border_color(
                objects.update_icon, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.update_icon)
            lv_obj_set_style_img_recolor(
                objects.update_icon, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.status)
            lv_obj_set_style_text_color(
                objects.status, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
    }
    {
        screen_brew_screen_state_t *state = &screen_brew_screen_state;
        ...
        if (objects.brew_screen)
            lv_obj_set_style_bg_color(
                objects.brew_screen, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj2)
            lv_obj_set_style_bg_color(
                objects.obj2, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj3)
            lv_obj_set_style_text_color(
                objects.obj3, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        if (objects.mode_switch)
            lv_obj_set_style_bg_color(
                objects.mode_switch, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.bluetooth_scale_icon)
            lv_obj_set_style_img_recolor(
                objects.bluetooth_scale_icon,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.flow_prediction_icon)
            lv_obj_set_style_img_recolor(
                objects.flow_prediction_icon,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.weight_label)
            lv_obj_set_style_text_color(
                objects.weight_label,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj4)
            lv_obj_set_style_text_color(
                objects.obj4, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.profile_select_button)
            lv_obj_set_style_img_recolor(
                objects.profile_select_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.profile_name)
            lv_obj_set_style_text_color(
                objects.profile_name,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.profile_name)
            lv_obj_set_style_bg_color(
        ...
        if (objects.target_temp)
            lv_obj_set_style_text_color(
                objects.target_temp, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.down_temp_button)
            lv_obj_set_style_img_recolor(
                objects.down_temp_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.up_temp_button)
            lv_obj_set_style_img_recolor(
                objects.up_temp_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj5)
            lv_obj_set_style_img_recolor(
                objects.obj5, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.target_duration)
            lv_obj_set_style_text_color(
                objects.target_duration,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj6)
            lv_obj_set_style_img_recolor(
                objects.obj6, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.up_duration_button)
            lv_obj_set_style_img_recolor(
                objects.up_duration_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.down_duration_button)
            lv_obj_set_style_img_recolor(
                objects.down_duration_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.target_weight_1)
            lv_obj_set_style_text_color(
                objects.target_weight_1,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj7)
            lv_obj_set_style_img_recolor(
                objects.obj7, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.up_weight_button)
            lv_obj_set_style_img_recolor(
                objects.up_weight_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.down_weight_button)
            lv_obj_set_style_img_recolor(
                objects.down_weight_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        if (objects.save_button)
            lv_obj_set_style_img_recolor(
                objects.save_button, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.accept_button)
            lv_obj_set_style_img_recolor(
                objects.accept_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.save_as_new_button)
            lv_obj_set_style_img_recolor(
                objects.save_as_new_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
            ...
            (void)startWidgetIndex;
            {
                ...
                (void)state;
                if (state->scale) {
                    state->scale->tick_color =
                        lv_color_hex(theme_colors[theme_index][5]);
                    state->scale->tick_major_color = lv_color_hex(0x000000);
                }
                if (state->indicator1) {
                    state->indicator1->type_data.scale_lines.color_start =
                        lv_color_hex(theme_colors[theme_index][6]);
                    state->indicator1->type_data.scale_lines.color_end =
                        lv_color_hex(theme_colors[theme_index][6]);
                }
                if (state->scale1) {
                    state->scale1->tick_color =
                        lv_color_hex(theme_colors[theme_index][5]);
                    state->scale1->tick_major_color = lv_color_hex(0x000000);
                }
                if (state->indicator3) {
                    state->indicator3->type_data.scale_lines.color_start =
                        lv_color_hex(theme_colors[theme_index][6]);
                    state->indicator3->type_data.scale_lines.color_end =
                        lv_color_hex(theme_colors[theme_index][6]);
                }
                if (state->scale2) {
                    state->scale2->tick_color =
                        lv_color_hex(theme_colors[theme_index][5]);
                    state->scale2->tick_major_color = lv_color_hex(0x000000);
                }
                if (state->indicator5) {
                    state->indicator5->type_data.scale_lines.color_start =
                        lv_color_hex(theme_colors[theme_index][7]);
                    state->indicator5->type_data.scale_lines.color_end =
                        lv_color_hex(theme_colors[theme_index][7]);
                }
                ...
                if (((lv_obj_t **)&objects)[startWidgetIndex + 5])
                    lv_obj_set_style_img_recolor(
                        ((lv_obj_t **)&objects)[startWidgetIndex + 5],
                        lv_color_hex(theme_colors[theme_index][2]),
                        LV_PART_MAIN | LV_STATE_CHECKED);
    ...
    }
    {
        ...
        if (objects.obj9)
            lv_obj_set_style_bg_color(
                objects.obj9, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.pause_button)
            lv_obj_set_style_img_recolor(
                objects.pause_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.check_button)
            lv_obj_set_style_img_recolor(
                objects.check_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.step_label)
            lv_obj_set_style_text_color(
                objects.step_label, lv_color_hex(theme_colors[theme_index][3]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.phase_label)
            lv_obj_set_style_text_color(
                objects.phase_label, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.brew_bar)
            lv_obj_set_style_bg_color(
                objects.brew_bar, lv_color_hex(theme_colors[theme_index][3]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.brew_bar)
            lv_obj_set_style_bg_color(
                objects.brew_bar, lv_color_hex(theme_colors[theme_index][2]),
                LV_PART_INDICATOR | LV_STATE_DEFAULT);
        if (objects.phase_progress)
            lv_obj_set_style_text_color(
                objects.phase_progress,
                lv_color_hex(theme_colors[theme_index][3]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.process_volume)
            lv_obj_set_style_text_color(
                objects.process_volume,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
    ...
    }
    {
        ...
        if (objects.menu_screen)
            lv_obj_set_style_bg_color(
                objects.menu_screen, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_brew)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_brew, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_steam)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_steam, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_water)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_water, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_grind)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_grind, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
    ...
    }
    {
        ...
        if (objects.menu_screen_new)
            lv_obj_set_style_bg_color(
                objects.menu_screen_new,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_brew_1)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_brew_1, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_steam_1)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_steam_1, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_water_1)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_water_1, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.btn_grind_1)
            lv_obj_set_style_bg_img_recolor(
                objects.btn_grind_1, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        ...
        if (objects.obj10)
            lv_obj_set_style_img_recolor(
                objects.obj10, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj11)
            lv_obj_set_style_img_recolor(
                objects.obj11, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj12)
            lv_obj_set_style_img_recolor(
                objects.obj12, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.info_btn)
            lv_obj_set_style_img_recolor(
                objects.info_btn, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.standby_btn)
            lv_obj_set_style_img_recolor(
                objects.standby_btn, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj13)
            lv_obj_set_style_text_color(
                objects.obj13, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
    ...
    }
    {
        ...
        if (objects.steam_screen)
            lv_obj_set_style_bg_color(
                objects.steam_screen,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.steam_down_temp_button)
            lv_obj_set_style_img_recolor(
                objects.steam_down_temp_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.steam_up_temp_button)
            lv_obj_set_style_img_recolor(
                objects.steam_up_temp_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj14)
            lv_obj_set_style_img_recolor(
                objects.obj14, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
    ...
    }
    {
        ...
        if (objects.water_start_button)
            lv_obj_set_style_img_recolor(
                objects.water_start_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.water_down_weight_button)
            lv_obj_set_style_img_recolor(
                objects.water_down_weight_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.water_up_weight_button)
            lv_obj_set_style_img_recolor(
                objects.water_up_weight_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.water_down_duration_button)
            lv_obj_set_style_img_recolor(
                objects.water_down_duration_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.water_up_duration_button)
            lv_obj_set_style_img_recolor(
                objects.water_up_duration_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.mode_switch_water)
            lv_obj_set_style_bg_color(
                objects.mode_switch_water,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.mode_switch_water)
            lv_obj_set_style_border_color(
        ...
        if (objects.obj15)
            lv_obj_set_style_img_recolor(
                objects.obj15, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj15)
            lv_obj_set_style_img_recolor(
                objects.obj15, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_CHECKED);
        if (objects.obj16)
            lv_obj_set_style_text_color(
                objects.obj16, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj16)
            lv_obj_set_style_text_color(
                objects.obj16, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_CHECKED);
        if (objects.water_down_temp_button)
            lv_obj_set_style_img_recolor(
                objects.water_down_temp_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.water_up_temp_button)
            lv_obj_set_style_img_recolor(
                objects.water_up_temp_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
    ...
    }
    {
        ...
        if (objects.profile_screen)
            lv_obj_set_style_bg_color(
                objects.profile_screen,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj18)
            lv_obj_set_style_bg_color(
                objects.obj18, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj19)
            lv_obj_set_style_text_color(
                objects.obj19, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.profile_name_1)
            lv_obj_set_style_text_color(
                objects.profile_name_1,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.profile_name_1)
            lv_obj_set_style_bg_color(
        ...
        if (objects.obj20)
            lv_obj_set_style_img_recolor(
                objects.obj20, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj21)
            lv_obj_set_style_text_color(
                objects.obj21, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj22)
            lv_obj_set_style_img_recolor(
                objects.obj22, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj23)
            lv_obj_set_style_img_recolor(
                objects.obj23, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj24)
            lv_obj_set_style_text_color(
                objects.obj24, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj25)
            lv_obj_set_style_text_color(
                objects.obj25, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj26)
            lv_obj_set_style_text_color(
                objects.obj26, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.select_profile)
            lv_obj_set_style_img_recolor(
                objects.select_profile,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.previous_profile)
            lv_obj_set_style_img_recolor(
                objects.previous_profile,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.next_profile)
            lv_obj_set_style_img_recolor(
                objects.next_profile,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
    ...
    }
    {
        ...
        if (objects.grind_screen)
            lv_obj_set_style_bg_color(
                objects.grind_screen,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_CHECKED);
        if (objects.grind_start_button)
            lv_obj_set_style_img_recolor(
                objects.grind_start_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.mode_switch1)
            lv_obj_set_style_bg_color(
                objects.mode_switch1,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.mode_switch1)
            lv_obj_set_style_border_color(
        ...
        if (objects.obj27)
            lv_obj_set_style_img_recolor(
                objects.obj27, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj27)
            lv_obj_set_style_img_recolor(
                objects.obj27, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_CHECKED);
        if (objects.obj28)
            lv_obj_set_style_text_color(
                objects.obj28, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj28)
            lv_obj_set_style_text_color(
                objects.obj28, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_CHECKED);
        if (objects.grind_down_weight_button)
            lv_obj_set_style_img_recolor(
                objects.grind_down_weight_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.grind_up_weight_button)
            lv_obj_set_style_img_recolor(
                objects.grind_up_weight_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.grind_down_duration_button)
            lv_obj_set_style_img_recolor(
                objects.grind_down_duration_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.grind_up_duration_button)
            lv_obj_set_style_img_recolor(
                objects.grind_up_duration_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        {
    ...
    }
    {
        ...
        if (objects.info_screen)
            lv_obj_set_style_bg_color(
                objects.info_screen, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj29)
            lv_obj_set_style_bg_color(
                objects.obj29, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.wifi_icon_1)
            lv_obj_set_style_border_color(
                objects.wifi_icon_1, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.wifi_icon_1)
            lv_obj_set_style_img_recolor(
                objects.wifi_icon_1, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.bluetooth_icon_1)
            lv_obj_set_style_border_color(
                objects.bluetooth_icon_1,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.bluetooth_icon_1)
            lv_obj_set_style_img_recolor(
        ...
        if (objects.obj30)
            lv_obj_set_style_text_color(
                objects.obj30, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj30)
            lv_obj_set_style_bg_color(
                objects.obj30, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj31)
            lv_obj_set_style_text_color(
                objects.obj31, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj32)
            lv_obj_set_style_text_color(
                objects.obj32, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj32)
            lv_obj_set_style_bg_color(
                objects.obj32, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj33)
            lv_obj_set_style_text_color(
                objects.obj33, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj34)
            lv_obj_set_style_text_color(
                objects.obj34, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.info_menu_icon)
            lv_obj_set_style_img_recolor(
                objects.info_menu_icon,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.info_menu_icon)
            lv_obj_set_style_bg_color(
    ...
    }
    {
        if (objects.new_profile_screen)
            lv_obj_set_style_bg_color(
                objects.new_profile_screen,
                lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj35)
            lv_obj_set_style_text_color(
                objects.obj35, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.prev_button)
            lv_obj_set_style_bg_img_recolor(
                objects.prev_button, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.prev_button)
            lv_obj_set_style_img_recolor(
                objects.prev_button, lv_color_hex(theme_colors[theme_index][0]),
        ...
        if (objects.obj36)
            lv_obj_set_style_text_color(
                objects.obj36, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj37)
            lv_obj_set_style_bg_color(
                objects.obj37, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj37)
            lv_obj_set_style_border_color(
                objects.obj37, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj38)
            lv_obj_set_style_img_recolor(
                objects.obj38, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj39)
            lv_obj_set_style_text_color(
                objects.obj39, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj40)
            lv_obj_set_style_img_recolor(
                objects.obj40, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj41)
            lv_obj_set_style_text_color(
                objects.obj41, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj42)
            lv_obj_set_style_text_color(
                objects.obj42, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj43)
            lv_obj_set_style_bg_color(
                objects.obj43, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj43)
            lv_obj_set_style_text_color(
                objects.obj43, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj44)
            lv_obj_set_style_bg_color(
                objects.obj44, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj44)
            lv_obj_set_style_text_color(
                objects.obj44, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.select_button)
            lv_obj_set_style_img_recolor(
                objects.select_button,
                lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.next_button)
            lv_obj_set_style_bg_img_recolor(
                objects.next_button, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.next_button)
            lv_obj_set_style_img_recolor(
                objects.next_button, lv_color_hex(theme_colors[theme_index][0]),
        ...
        if (objects.obj45)
            lv_obj_set_style_bg_color(
                objects.obj45, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj46)
            lv_obj_set_style_text_color(
                objects.obj46, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj47)
            lv_obj_set_style_img_recolor(
                objects.obj47, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj48)
            lv_obj_set_style_img_recolor(
                objects.obj48, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj49)
            lv_obj_set_style_text_color(
                objects.obj49, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj50)
            lv_obj_set_style_text_color(
                objects.obj50, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj51)
            lv_obj_set_style_bg_color(
                objects.obj51, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj51)
            lv_obj_set_style_text_color(
                objects.obj51, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj52)
            lv_obj_set_style_text_color(
                objects.obj52, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj53)
            lv_obj_set_style_img_recolor(
                objects.obj53, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj54)
            lv_obj_set_style_img_recolor(
                objects.obj54, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj55)
            lv_obj_set_style_text_color(
                objects.obj55, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj56)
            lv_obj_set_style_text_color(
                objects.obj56, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj57)
            lv_obj_set_style_bg_color(
                objects.obj57, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj57)
            lv_obj_set_style_text_color(
                objects.obj57, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj58)
            lv_obj_set_style_text_color(
                objects.obj58, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj59)
            lv_obj_set_style_img_recolor(
                objects.obj59, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj60)
            lv_obj_set_style_img_recolor(
                objects.obj60, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj61)
            lv_obj_set_style_text_color(
                objects.obj61, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj62)
            lv_obj_set_style_text_color(
                objects.obj62, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj63)
            lv_obj_set_style_bg_color(
                objects.obj63, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj63)
            lv_obj_set_style_text_color(
                objects.obj63, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj64)
            lv_obj_set_style_text_color(
                objects.obj64, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj65)
            lv_obj_set_style_img_recolor(
                objects.obj65, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj66)
            lv_obj_set_style_img_recolor(
                objects.obj66, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj67)
            lv_obj_set_style_text_color(
                objects.obj67, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj68)
            lv_obj_set_style_text_color(
                objects.obj68, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj69)
            lv_obj_set_style_bg_color(
                objects.obj69, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj69)
            lv_obj_set_style_text_color(
                objects.obj69, lv_color_hex(theme_colors[theme_index][1]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj70)
            lv_obj_set_style_img_recolor(
                objects.obj70, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
        if (objects.obj71)
            lv_obj_set_style_img_recolor(
                objects.obj71, lv_color_hex(theme_colors[theme_index][0]),
                LV_PART_MAIN | LV_STATE_DEFAULT);
    }
    lv_style_set_text_color(get_style_text_theme_color_MAIN_DEFAULT(),
                            lv_color_hex(theme_colors[theme_index][0]));
    lv_style_set_img_recolor(get_style_images_theme_color_MAIN_DEFAULT(),
                             lv_color_hex(theme_colors[theme_index][0]));
    lv_style_set_bg_color(get_style_screen_theme_color_MAIN_DEFAULT(),
                          lv_color_hex(theme_colors[theme_index][1]));
    if (objects.standby_screen)
...
uint32_t theme_colors[3][8] = {
    {0xfffafafa, 0xff131313, 0xff1ffba3, 0xffcccccc, 0xff0069ad, 0xffebebeb,
     0xfff62c2c, 0xff2ca4f6},
    {0xff131313, 0xfffafafa, 0xff1ffba3, 0xffcccccc, 0xff0069ad, 0xffebebeb,
     0xfff62c2c, 0xff2a92f6},
    {0xfffafafa, 0xff000000, 0xff1ffba3, 0xffcccccc, 0xff0069ad, 0xffebebeb,
     0xfff62c2c, 0xff2ca4f6},
};
...
void create_screens() {
    ...
    eez_flow_init_style_names(style_names,
                              sizeof(style_names) / sizeof(const char *));

    eez_flow_init_fonts(fonts, sizeof(fonts) / sizeof(ext_font_desc_t));

    eez_flow_init_themes(theme_names,
                         sizeof(theme_names) / sizeof(const char *),
                         change_color_theme, &theme_colors[0][0],
