...
extern void action_on_water_reminder_open(lv_event_t *e);
extern void action_on_water_reminder_secondary(lv_event_t *e);
extern void action_on_water_reminder_primary(lv_event_t *e);
