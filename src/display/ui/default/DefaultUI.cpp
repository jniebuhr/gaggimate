...
void DefaultUI::setupReactive() {
    ...
    effect_mgr.use_effect([=] { return currentScreen == ui_StandbyScreen; }, [=]() { adjustDials(ui_StandbyScreen_dials); },
                          &pressureAvailable);
    effect_mgr.use_effect([=] { return currentScreen == ui_StandbyScreen; }, [=]() { adjustHeatingIndicator(ui_StandbyScreen_dials); },
                          &isTemperatureStable, &heatingFlash);
    ...
    effect_mgr.use_effect([=] { return currentScreen == ui_StandbyScreen; },
                          [=]() {
                              lv_arc_set_value(uic_StandbyScreen_dials_tempGauge, currentTemp);
                              lv_label_set_text_fmt(ui_StandbyScreen_targetTemp, "%d°C", currentTemp);
                          },
                          &currentTemp);
    effect_mgr.use_effect([=] { return currentScreen == ui_StandbyScreen; },
                          [=]() {
                              adjustTempTarget(ui_StandbyScreen_dials);
                          },
                          &targetTemp);
...
inline void DefaultUI::adjustTempTarget(lv_obj_t *dials) {
    double gaugeAngle = 304;
    double gaugeStart = -62;
